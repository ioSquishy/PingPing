...
public class YoutubeSub extends StreamerSubscription {
    ...
    public YoutubeSub(long server_id, String broadcaster_id, long pingrole_id, long pingchannel_id, String uploads_playlist_id, String broadcaster_handle, String last_stream_video_id) {
